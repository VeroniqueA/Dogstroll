...
ActiveRecord::Schema.define(version: 2019_10_24_152524) do
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.index ["dog_sitter_id"], name: "index_cities_on_dog_sitter_id"
    t.index ["stroll_id"], name: "index_cities_on_stroll_id"
  end
